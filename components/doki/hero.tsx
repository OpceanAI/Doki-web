    ...
    <section className="relative min-h-[100dvh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-[var(--max-width)] mx-auto px-6 py-32 text-center">
        ...
        >
          ...
          <button
            onClick={copyCommand}
            className="ml-2 p-1.5 rounded hover:bg-[var(--bg-300)] text-[var(--text-500)] hover:text-[var(--text-200)] transition-colors"
        ...
        >
          <div className="text-center">
            <div className="text-2xl font-semibold text-[var(--text-100)] font-mono">6.6MB</div>
            <div className="text-xs text-[var(--text-500)] mt-1">Binary size</div>
          </div>
          <div className="hidden sm:block w-px h-10 bg-[var(--border-100)]" />
          <div className="text-center">
            <div className="text-2xl font-semibold text-[var(--text-100)] font-mono">12MB</div>
            <div className="text-xs text-[var(--text-500)] mt-1">Memory idle</div>
          </div>
          <div className="hidden sm:block w-px h-10 bg-[var(--border-100)]" />
          <div className="text-center">
            <div className="text-2xl font-semibold text-[var(--accent-cyan)] font-mono">&lt;15ms</div>
            <div className="text-xs text-[var(--text-500)] mt-1">Cold start</div>
          </div>
          <div className="hidden sm:block w-px h-10 bg-[var(--border-100)]" />
          <div className="text-center">
            <div className="text-2xl font-semibold text-[var(--text-100)] font-mono">0</div>
