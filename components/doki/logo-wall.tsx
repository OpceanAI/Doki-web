...
function LogoItem({ logo }: { logo: typeof logos[0] }) {
  return (
    <div className="flex items-center justify-center px-8 py-4 text-[var(--text-500)] hover:text-[var(--text-100)] transition-colors duration-300 cursor-default">
...
export function LogoWall() {
  ...
  return (
    <section ref={ref} className="relative py-[var(--section-padding)] bg-[var(--bg-000)] overflow-hidden">
      ...
      <div className="max-w-[var(--max-width)] mx-auto px-6">
        ...
        <div className={`space-y-6 transition-all duration-700 delay-200 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>
          ...
          <div className="relative overflow-hidden">
            <div className="absolute left-0 top-0 bottom-0 w-24 bg-gradient-to-r from-[var(--bg-000)] to-transparent z-10 pointer-events-none" />
            <div className="absolute right-0 top-0 bottom-0 w-24 bg-gradient-to-l from-[var(--bg-000)] to-transparent z-10 pointer-events-none" />
