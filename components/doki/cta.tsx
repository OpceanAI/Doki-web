...
export function CTA() {
  ...
  const copyCommand = useCallback(async () => {
    ...
    setCopied(true)
    toast({ title: t('copied'), description: "Command copied to clipboard" })
        ...
        <div className="max-w-[var(--measure)] mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-3 bg-[var(--ink)] rounded-full px-4 sm:px-5 py-3 mb-8 max-w-full overflow-x-auto">
            ...
            <button
              ...
              aria-label={copied ? t('copied') : "Copy command"}
            >
              {copied ? (
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            <Link href="https://github.com/OpceanAI/Doki" target="_blank" rel="noopener noreferrer" className="btn-primary ">
